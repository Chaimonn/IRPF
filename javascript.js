function formula() {
  ...
  var sal = document.getElementById("salbruto").value;
  var porcINSS;
  var INSS;
  var porcIRPF;
  var dIRPF;
  ...
  if (sal>5839.45) {
    document.getElementsByTagName('table')[0].innerHTML+="<tr><th>"+nome+"</td><td>R$"+sal+"</td><td>R$"+porcINSS+"</td><td>R$"+arreINSS+"</td><td>"+porcIRPF+"%</td><td>"+arreIRPF+"</td><td>"+arredondado+"</td><tr>";
  }
